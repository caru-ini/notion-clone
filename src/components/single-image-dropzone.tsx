    ...
    return (
      <div className={"relative"}>
        {disabled && (
          <div
            className={
              "absolute inset-y-0 z-50 flex size-full items-center justify-center bg-background/80"
            }
          >
            {" "}
            <Spinner />
        ...
        >
          ...
          {imageUrl && !disabled && (
            ...
            >
              <div
                className={
                  "flex size-5 items-center justify-center rounded-md border border-solid border-gray-500 bg-white transition-all duration-300 hover:size-6 dark:border-gray-400 dark:bg-black"
                }
              >
